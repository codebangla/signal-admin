...
@Component({
  ...
  template: `
    ...
    <form [formGroup]="userForm" (ngSubmit)="onSubmit()" class="space-y-4 p-2">
      ...
      <mat-form-field appearance="outline" class="w-full">
        ...
        <mat-error *ngIf="userForm.get('status')?.hasError('required')">Status is required</mat-error>
      </mat-form-field>
      <mat-form-field appearance="outline" class="w-full">
      ...
      <div class="flex justify-end space-x-2 mt-4">
        ...
        <button mat-raised-button color="primary" type="submit" [disabled]="userForm.invalid">{{ data ? 'Update' : 'Add' }}</button>
      </div>
    </form>
  `
})
